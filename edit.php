...
<body>
    <?php
        ...
        $isbn = $_GET['isbn'];
        $buku=mysqli_query($con, "SELECT * FROM buku WHERE isbn='$isbn'");
...
<?php
    if(isset($_POST['Submit'])){
        ...
        $result=mysqli_query($con, "UPDATE buku SET judul = '$judul', tahun ='$tahun', id_penerbit = '$id_penerbit', id_pengarang= '$id_pengarang', id_katalog='$id_katalog', qty_stok='$qty_stok', harga_pinjam = '$harga_pinjam' WHERE isbn= '$isbn';");       
